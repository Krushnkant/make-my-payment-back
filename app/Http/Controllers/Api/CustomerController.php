...
class CustomerController extends Controller
{
    ...
    {
        $this->allowedLanguages = ['BN', 'EN', 'GU', 'HI', 'KN', 'MR', 'ML', 'PA', 'TA', 'TE'];
    }
    ...
    public function create(Request $request)
    {
        try {
            ...
            $validator=Validator::make($request->all(),[
                'business_id' => 'required',
                'name'=> 'required',
                // 'native_language'=> ['required', Rule::in($allowedLanguages)],
                'phone' => ['required', 'regex:/^[0-9]{10}$/'],
                'email'=> 'nullable|email',
            ], [
                'native_language.in' => 'The selected language is not allowed. Please choose a valid option.',
            ]);
            ...
            if($validator->fails()){
                ...
                $customer->native_language = isset($request->native_language) ? $request->native_language : 'HI';
