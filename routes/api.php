...
Route::get('languages', 'Api\AuthController@Languages');
...
Route::group(['middleware' => ['auth:sanctum']], function(){
    ...
    //Dashborad Api
    Route::get('ads/ids','Api\AdsController@getAdsInfo');  //Dashbaord Api
    ...
    Route::post('update_sms_call_credit', 'Api\UserController@updateSmsCallCredit'); // Increase SMS/Call Credit to the User
    ...
    Route::post('update-call-status', 'Api\WebhookController@update_call_status'); // Update Call Status
...
// Use only for Developer to Manually Remove Package from Users
Route::post('update_user_package ', 'Api\PackageController@UpdateUserPackage'); // Remove Package that was added without Payment/Unpaid
