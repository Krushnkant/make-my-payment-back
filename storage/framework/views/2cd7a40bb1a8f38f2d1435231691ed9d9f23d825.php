                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <select class="form-select" aria-label="Default select example" id="user" onchange="getUser()">
                                                ...
                                                <?php $__currentLoopData = App\Models\User::where('user_type', 'customer')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-lg-4" id="monthdata">
                                            ...
                                            <select class="form-select col-lg-6" aria-label="Default select example" id="month">
                                                <?php $__currentLoopData = $finalyear; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
function getMonthdata(params) {
    ...
    $.ajax({  
        type: 'POST',
        url: '<?php echo e(route('transection.month.data')); ?>', 
        data: { 
            year: year ,
            chart:chart,
            user: user,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/reports/transection.blade.php ENDPATH**/ ?>